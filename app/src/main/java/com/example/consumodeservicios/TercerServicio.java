...
public class TercerServicio extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_tercer_servicio);
    ...
    private void hacerSolicitud(final TextView txtRespuesta) {
        // URL del servidor
        String url = "http://10.10.13.65:3000/suma";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(TercerServicio.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
